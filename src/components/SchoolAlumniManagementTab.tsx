...
const SchoolAlumniManagementTab = (props: AlumniManagementTabProps) => {
  ...
  const handleSaveStudent = async () => {
    try {
      ...
      const apiUserRole = props.userRole === "school" ? "admin" : (props.userRole || "student");
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <Dialog open={!!editingStudent && props.userRole === "school"} onOpenChange={open => { if (!open) handleCancelEdit(); }}>
...
export default SchoolAlumniManagementTab;
