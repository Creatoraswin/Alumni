          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/3 flex flex-col items-center lg:items-start space-y-6">
              ...
              <div className="w-full space-y-3 pt-6 lg:pt-8 w-full max-w-sm">
                ...
                {student.linkedinId && student.linkedinId !== "Not specified" && student.linkedinId !== "NA" && (
                  <div className="w-full">
                    ...
                    {/* <div className="mt-2 text-xs text-muted-foreground break-all text-center lg:text-left px-1">
                      <a 
